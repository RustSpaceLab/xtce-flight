...
for symbol in encode_numeric_edges encode_status_report encode_beacon decode_jpss calibrate_all round_trip_little_endian round_trip_arrays round_trip_aggregates; do
